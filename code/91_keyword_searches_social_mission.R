...
## Import data ----
analytic_df <-
    readRDS(here::here("data_private", "social_mission_analytic_df.RDS"))
word_df <-
    readRDS(here::here("data_private", "social_mission_tokenized_words.RDS"))
sentence_df <-
    readRDS(here::here("data_private", "social_mission_tokenized_sentences.RDS"))
ngram2_df <-
    readRDS(here::here("data_private", "social_mission_tokenized_bigrams.RDS"))
ngram3_df <-
    readRDS(here::here("data_private", "social_mission_tokenized_trigrams.RDS"))
...
reshape_criterion <- function(analytic_df,
    ...
    analytic_df %>% 
        arrange(random_id) %>% 
        select(institution_id = random_id, hbcu, low_urm, high_urm) %>% 
        mutate(criterion = rule_name) %>%
...
## Save ----
saveRDS(summary_df,
        here::here("data_private", "social_mission_keyword_summary_df.RDS"))
readr::write_csv(summary_df, here::here("data", "social_mission_keyword_results.csv"))
