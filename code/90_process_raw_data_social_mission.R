## 90_process_raw_data_social_mission.R ----
##
...
## Constants ----
CURRENT_FILE_NAME <-"current_download_social_mission.csv"
MANUAL_STOPWORDS <-
    c(
        "00",
        "19",
...
saveRDS(analytic_df, here::here("data_private", "social_mission_analytic_df.RDS"))
readr::write_csv(
    analytic_df %>%
        dplyr::select(institution, nih_rank, usnwr_rank, random_id),
    here::here("data_private", "social_mission_random_id_mapping.csv")
)

## Save tokenized data
saveRDS(word_df, here::here("data_private", "social_mission_tokenized_words.RDS"))
saveRDS(sentence_df,
        here::here("data_private", "social_mission_tokenized_sentences.RDS"))
saveRDS(ngram2_df,
        here::here("data_private", "social_mission_tokenized_bigrams.RDS"))
saveRDS(ngram3_df,
        here::here("data_private", "social_mission_tokenized_trigrams.RDS"))
